...
class DocumentoDuplicadoError(RegraDeNegocioError):
    """Lançada ao tentar cadastrar/atualizar um cliente com CPF ou CNPJ já existente."""
    pass


class TipoPessoaInvalidoError(RegraDeNegocioError):
    """Lançada quando um tipo de pessoa inválido é informado (esperado 'PF' ou 'PJ')."""
    pass
