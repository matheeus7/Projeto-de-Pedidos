...
demonstrando o uso de classe abstrata, encapsulamento e o ponto de
extensão para o polimorfismo do método exibir_dados().

Hierarquia:
    Pessoa (abstrata)
    ├── PessoaFisica   — clientes com CPF (pessoa física)
    └── PessoaJuridica — clientes com CNPJ (pessoa jurídica)
"""
...
class Pessoa(ABC):
    ...
    Não pode ser instanciada diretamente. Subclasses concretas
    (PessoaFisica, PessoaJuridica) devem implementar exibir_dados().
    """
    ...
    def exibir_dados(self) -> str:
        ...
        PessoaFisica → inclui CPF e telefone.
        PessoaJuridica → inclui CNPJ, razão social e nome fantasia.
        """
